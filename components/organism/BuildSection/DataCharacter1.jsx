...
export default function DataCharacter1({
  dataCharacters,
  dataArtifacts,
  form,
  setForm,
  ...
  const Character =
    dataCharacters[findData(form.dataCharacter1, dataCharacters)];
  const Weapon = dataWeapon[findData(form.dataWeapon1, dataWeapon)];
  const Artifact1 =
    dataArtifacts[findData(form.dataArtifact1_1, dataArtifacts)];
  const Artifact2 =
  ...
  return (
    <div className="w-11/12 p-2 bg-gray-700 rounded-lg items-center flex flex-col">
      ...
      <SelectItem
        name="Character 1"
        value={form.dataCharacter1}
        onChange={(e) => setForm({ ...form, dataCharacter1: e.target.value })}
      ...
      <SelectItem
        name="Weapon"
        value={form.dataWeapon1}
        onChange={(e) => setForm({ ...form, dataWeapon1: e.target.value })}
        dataItem={dataWeapon}
        isWeapon
        hasData
      />
      ...
      <div className="flex flex-row items-center">
        <SelectItem
          value={form.dataArtifact1_1}
          onChange={(e) =>
            setForm({ ...form, dataArtifact1_1: e.target.value })
          }
        ...
        />
        <SelectItem
          value={form.dataArtifact2_1}
          onChange={(e) =>
            setForm({ ...form, dataArtifact2_1: e.target.value })
          }
          dataItem={dataArtifacts}
          isAritfact
          hasData
      ...
      <div className="flex flex-col w-full space-y-2">
        <div className="flex flex-row">
          <SelectItem
            name="Flower"
            value={form.flower1}
            onChange={(e) => setForm({ ...form, flower1: e.target.value })}
          >
          ...
          <SelectItem
            name="Plume"
            value={form.plume1}
            onChange={(e) => setForm({ ...form, plume1: e.target.value })}
          >
        ...
        <div className="flex flex-row">
          <SelectItem
            name="Sands"
            value={form.sands1}
            onChange={(e) => setForm({ ...form, sands1: e.target.value })}
          >
            <option value="HP%">HP%</option>
            <option value="ATK%">ATK%</option>
          ...
          <SelectItem
            name="Goblet"
            value={form.goblet1}
            onChange={(e) => setForm({ ...form, goblet1: e.target.value })}
          >
            <option value="ATK%">ATK%</option>
            <option value="HP%">HP%</option>
            <option value="DEF%">DEF%</option>
        ...
        <SelectItem
          name="Circlet"
          value={form.circlet1}
          onChange={(e) => setForm({ ...form, circlet1: e.target.value })}
        >
          <option value="HP%">HP%</option>
          <option value="ATK%">ATK%</option>
          <option value="DEF%">DEF%</option>
