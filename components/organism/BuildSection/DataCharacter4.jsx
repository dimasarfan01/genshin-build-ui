...
export default function DataCharacter4({
  dataCharacters,
  dataArtifacts,
  form,
  setForm,
  ...
  const Character =
    dataCharacters[findData(form.dataCharacter4, dataCharacters)];
  const Weapon = dataWeapon[findData(form.dataWeapon4, dataWeapon)];
  const Artifact1 =
    dataArtifacts[findData(form.dataArtifact1_4, dataArtifacts)];
  const Artifact2 =
    dataArtifacts[findData(form.dataArtifact2_4, dataArtifacts)];
  return (
    <div className="w-11/12 p-2 bg-gray-700 rounded-lg items-center flex flex-col">
      ...
      <SelectItem
        name="Character 4"
        value={form.dataCharacter4}
        onChange={(e) => setForm({ ...form, dataCharacter4: e.target.value })}
      ...
      <SelectItem
        name="Weapon"
        value={form.dataWeapon4}
        onChange={(e) => setForm({ ...form, dataWeapon4: e.target.value })}
        dataItem={dataWeapon}
        isWeapon
        hasData
      />
      ...
      <div className="flex flex-row items-center">
        <SelectItem
          value={form.dataArtifact1_4}
          onChange={(e) =>
            setForm({ ...form, dataArtifact1_4: e.target.value })
          }
        ...
        />
        <SelectItem
          value={form.dataArtifact2_4}
          onChange={(e) =>
            setForm({ ...form, dataArtifact2_4: e.target.value })
          }
          dataItem={dataArtifacts}
          isAritfact
          hasData
      ...
      <div className="flex flex-col w-full space-y-2">
        <div className="flex flex-row">
          <SelectItem
            name="Flower"
            value={form.flower4}
            onChange={(e) => setForm({ ...form, flower4: e.target.value })}
          >
          ...
          <SelectItem
            name="Plume"
            value={form.plume4}
            onChange={(e) => setForm({ ...form, plume4: e.target.value })}
          >
        ...
        <div className="flex flex-row">
          <SelectItem
            name="Sands"
            value={form.sands4}
            onChange={(e) => setForm({ ...form, sands4: e.target.value })}
          >
            <option value="HP%">HP%</option>
            <option value="ATK%">ATK%</option>
          ...
          <SelectItem
            name="Goblet"
            value={form.goblet4}
            onChange={(e) => setForm({ ...form, goblet4: e.target.value })}
          >
            <option value="ATK%">ATK%</option>
            <option value="HP%">HP%</option>
            <option value="DEF%">DEF%</option>
        ...
        <SelectItem
          name="Circlet"
          value={form.circlet4}
          onChange={(e) => setForm({ ...form, circlet4: e.target.value })}
        >
          <option value="HP%">HP%</option>
          <option value="ATK%">ATK%</option>
          <option value="DEF%">DEF%</option>
