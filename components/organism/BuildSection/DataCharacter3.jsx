...
export default function DataCharacter3({
  dataCharacters,
  dataArtifacts,
  form,
  setForm,
  ...
  const Character =
    dataCharacters[findData(form.dataCharacter3, dataCharacters)];
  const Weapon = dataWeapon[findData(form.dataWeapon3, dataWeapon)];
  const Artifact1 =
    dataArtifacts[findData(form.dataArtifact1_3, dataArtifacts)];
  const Artifact2 =
    dataArtifacts[findData(form.dataArtifact2_3, dataArtifacts)];
  return (
    <div className="w-11/12 p-2 bg-gray-700 rounded-lg items-center flex flex-col">
      ...
      <SelectItem
        name="Character 3"
        value={form.dataCharacter3}
        onChange={(e) => setForm({ ...form, dataCharacter3: e.target.value })}
      ...
      <SelectItem
        name="Weapon"
        value={form.dataWeapon3}
        onChange={(e) => setForm({ ...form, dataWeapon3: e.target.value })}
        dataItem={dataWeapon}
        isWeapon
        hasData
      />
      ...
      <div className="flex flex-row items-center">
        <SelectItem
          value={form.dataArtifact1_3}
          onChange={(e) =>
            setForm({ ...form, dataArtifact1_3: e.target.value })
          }
        ...
        />
        <SelectItem
          value={form.dataArtifact2_3}
          onChange={(e) =>
            setForm({ ...form, dataArtifact2_3: e.target.value })
          }
          dataItem={dataArtifacts}
          isAritfact
          hasData
      ...
      <div className="flex flex-col w-full space-y-2">
        <div className="flex flex-row">
          <SelectItem
            name="Flower"
            value={form.flower3}
            onChange={(e) => setForm({ ...form, flower3: e.target.value })}
          >
          ...
          <SelectItem
            name="Plume"
            value={form.plume3}
            onChange={(e) => setForm({ ...form, plume3: e.target.value })}
          >
        ...
        <div className="flex flex-row">
          <SelectItem
            name="Sands"
            value={form.sands3}
            onChange={(e) => setForm({ ...form, sands3: e.target.value })}
          >
            <option value="HP%">HP%</option>
            <option value="ATK%">ATK%</option>
          ...
          <SelectItem
            name="Goblet"
            value={form.goblet3}
            onChange={(e) => setForm({ ...form, goblet3: e.target.value })}
          >
            <option value="ATK%">ATK%</option>
            <option value="HP%">HP%</option>
            <option value="DEF%">DEF%</option>
        ...
        <SelectItem
          name="Circlet"
          value={form.circlet3}
          onChange={(e) => setForm({ ...form, circlet3: e.target.value })}
        >
          <option value="HP%">HP%</option>
          <option value="ATK%">ATK%</option>
          <option value="DEF%">DEF%</option>
